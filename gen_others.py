...
def save_images(images, names):
    ...
    for img, name in zip(images, names):
        ...
        cv2.imwrite("pictures/{}.png".format(name), img)
        # cv2.imshow("img", img)
        # cv2.waitKey()
...
if __name__ == "__main__":
    ...
    for gen in tqdm(range(1000)):
        ...
        os.system("mkdir -p pictures/female_smile_1000/")
        names.append("female_smile_1000/female_smile_"+str(gen))
        ...
        os.system("mkdir -p pictures/male_neutral_1000/")
        names.append("male_neutral_1000/male_neutral_"+str(gen))
        ...
        os.system("mkdir -p pictures/female_neutral_1000/")
        names.append("female_neutral_1000/female_neutral_"+str(gen))
